...
*输入区域的工具栏按钮：添加上下文、模式切换、引导助手开关、搜索、列表和模型选择*
...
| **对话模式** | 🗣️/🤖 | 在普通模式和代理模式之间切换 | 始终 |
| **引导助手** | 🎯 | 在普通模式中切换分步引导 | 普通模式 |
| **内置工具管理** | 🛠️ | 按类别启用/禁用内置工具 | 普通模式和代理模式 |
| **MCP 服务器** | 🔌 | 管理外部 MCP 工具服务器 | 普通模式和代理模式 |
...
在普通模式、引导助手和代理模式之间灵活协作:

![对话模式选择](../assets/screenshots/conversation-modes.png)
*对话控制区域（高亮区域）：普通模式、引导助手开关、代理模式*
