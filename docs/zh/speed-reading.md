...
- **导出与管理**：支持导出为 Markdown 笔记，或将思维导图复制为 SVG/PNG 图片
- **自定义分析**：允许由于户在提示词管理中添加自定义的速读分析维度
- **延伸阅读**：基于内容的相关主题建议
- **可能感兴趣**：根据笔记内容推测的延伸话题
...
- 使用 **jsMind** 生成交互式思维导图
- 支持节点展开/折叠
- 交互控制：支持 **放大/缩小**、**自适应视图** 及 **全屏模式**
- 清晰展示笔记的层次结构
- 至少 3 层节点深度

### 5. 导出与输出选项

- **导出至笔记**：将整个分析结果（含思维导图）保存为库内的新 Markdown 笔记
- **复制为 Markdown**：将文本内容（摘要、要点、建议）复制到剪贴板
- **思维导图导出**：支持将导图导出为 **SVG** 或 **PNG** 图片，便于在其他地方使用
- **Markdown 列表导出**：将思维导图结构导出为层级化的 Markdown 列表

### 6. 自定义分析维度

- 用户可以在 **提示词管理** 中定义自己的 "Speed Reading" 类型提示词
- 这些自定义部分将自动出现在每份速读报告的底部
- 适用于 "行动清单"、"技术债务分析" 或 "个人心得" 等专门场景
