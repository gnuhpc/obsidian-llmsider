...
![Multi-Model Support Demo](https://github.com/gnuhpc/obsidian-llmsider/releases/download/v0.0.1/models-connetions.gif)
...
![Normal Mode Demo](https://github.com/gnuhpc/obsidian-llmsider/releases/download/v0.0.1/normal-mode.gif)
...
![Quick Chat Demo](https://github.com/gnuhpc/obsidian-llmsider/releases/download/v0.0.1/quickchat.gif)
...
![Multi-Model Comparison Demo](https://github.com/gnuhpc/obsidian-llmsider/releases/download/v0.0.1/vision-understanding.gif)
...
![Speed Reading Demo](https://github.com/gnuhpc/obsidian-llmsider/releases/download/v0.0.1/speed-reading.gif)
