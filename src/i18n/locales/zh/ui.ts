...
export const zhUI = {
  ...
  skillsSwitchOn: 'Skills 已开启',
  skillsSwitchOff: 'Skills 已关闭',
  skillsEnabled: '当前聊天已开启 Skills',
  skillsDisabled: '当前聊天已关闭 Skills',
  noSkill: '无 Skill',
  noSkillDesc: '当前聊天使用基础助手行为。',
  noActiveChatSession: '当前没有活动聊天会话',
...
{globalSuffix}`,
  ...
  chatHistoryEmpty: '未找到会话',
  chatHistoryUntitledConversation: '未命名会话',
  chatHistoryMessageCount: '{count} 条消息',
  chatHistoryDeleteConversation: '删除会话',
  chatHistoryDeleteAll: '全部删除',
  chatHistoryDeleteAllAriaLabel: '删除所有会话',
  chatHistoryDeleteAllDone: '已删除所有会话',
  chatHistoryImagePlaceholder: '[图片]',
  chatHistoryMaxLimitTitle: '聊天历史已达上限',
  chatHistoryMaxLimitMessage: '你已达到最多 {count} 个聊天会话的上限。',
  chatHistoryMaxLimitWarning: '创建新会话时，将自动移除最早的会话。',
  chatHistoryMaxLimitProceed: '继续并移除最早会话',
  ...
  skillsHeader: 'Skills',
  allSkills: '所有 Skills',
  currentChatSkills: '当前聊天',
  searchSkills: '搜索 Skills...',
  noSkillsAvailable: '没有可用的 Skills',
  noMatchingSkills: '未找到匹配的 Skills',
  toolEnabled: '已启用',
  toolDisabled: '已禁用',
  skillEnabled: '已启用',
  skillDisabled: '已禁用',
  allSkillsEnabled: '所有 Skills 已启用',
  allSkillsDisabled: '所有 Skills 已禁用',
  ...
  cannotChangeSkillDuringExecution: '执行期间无法切换 Skill',
  cannotAddContextDuringExecution: '执行期间无法添加上下文',
  skillManagerNotInitialized: 'Skill 管理器尚未初始化',
  skillMatched: '已命中 Skill：{skill}',
  skillsReloaded: '已重载 {count} 个本地 skill',
  skillsReloadedWithErrors: '已重载 skills，但有 {count} 个错误',
  ...
  activeSkillCleared: '当前聊天的 Skill 已清除',
  ...
  continueQuestion: '是否继续使用引导助手？',
  continueWithSuggestions: '继续获取建议',
  endGuidedMode: '关闭引导助手',
  guidedModeEnded: '引导助手已关闭。您可以继续正常聊天，或随时再次打开。',
...
- 对于写入类请求：最终答复必须包含明确的写入成功信号（例如“已创建/已保存”）。`,
  ...
  // Provider 限制警告
  freeQwenToolCallWarning: '⚠️ Free Qwen 不支持自动工具调用。在引导助手 / 智能代理模式下，AI 可能只能用文本描述工具，无法直接执行。建议使用付费的 Qwen (DashScope) 或切换到普通模式。',
  ...
  webllm: {
    sectionTitle: '🧠 本地推理引擎',
    sectionDesc: '使用 WebGPU 在本地运行 AI 模型，无需联网或外部服务',
    enableWebLLM: '启用本地推理',
    enableWebLLMDesc: '开启后可使用 WebGPU 在本地进行 AI 推理，无需 API 密钥',
    webgpuSupported: '✅ 您的设备支持 WebGPU',
    webgpuNotSupported: '❌ 您的设备不支持 WebGPU，请更新显卡驱动',
    ...
    unloadModel: '卸载模型',
    clearCache: '清理缓存',
    clearCacheConfirm: '确定要清理模型缓存吗？下次使用需要重新下载',
    cacheCleared: '缓存已清理',
    modelReady: '✅ 模型已就绪，可以开始对话',
    modelSize: '模型大小',
    contextWindow: '上下文窗口',
    autoLoad: '启动时自动加载',
    autoLoadDesc: '启动 Obsidian 时自动加载选中的本地模型',
    statusIdle: '空闲',
    ...
    notCached: '未缓存',
    recommended: '推荐',
    connectionTitle: 'WebLLM (本地推理)',
    connectionDesc: '使用您设备的 GPU (WebGPU) 直接在 Obsidian 中运行语言模型。推理过程无需 API 密钥或互联网连接（仅在初始下载模型时需要网络）。',
    quantization: '量化方式',
  }
};
