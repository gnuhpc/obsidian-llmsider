...
export const zhFundsTools = {
	...
	getFundManagerPerformance: {
		name: '获取基金经理业绩',
		description: '获取基金经理业绩排名和统计数据'
	},
	getFundFlow: {
		name: '获取基金资金流向',
		description: '获取基金申购赎回资金流向数据'
	},
	getEtfTracking: {
		name: '获取ETF跟踪数据',
		description: '获取ETF实时跟踪数据，包括跟踪误差、溢价折价率'
	},
	getFundAllocationIndex: {
		name: '获取基金配置指数',
		description: '获取基金资产配置指数，包括股票仓位、债券仓位、行业配置'
	},
	getFundComparison: {
		name: '获取基金对比',
		description: '比较多只基金的业绩指标，包括收益率、波动率、夏普比率、最大回撤'
	},
	getFundFees: {
		name: '获取基金费率',
		description: '获取基金费率结构，包括申购费、赎回费、管理费、托管费'
	},
	getFundRiskMetrics: {
		name: '获取基金风险指标',
		description: '获取基金风险指标，包括波动率、贝塔系数、夏普比率、最大回撤、VaR'
	},
	getFundStyleAnalysis: {
		name: '获取基金风格分析',
		description: '获取基金投资风格分析，包括成长/价值取向、行业偏好'
	},
	getFundCompanyRanking: {
		name: '获取基金公司排名',
		description: '获取基金公司排名，按总资产、基金数量、平均业绩排序'
	},
	getEtfArbitrage: {
		name: '获取ETF套利机会',
		description: '获取基于溢价折价率的ETF套利机会'
	},
	getLofArbitrage: {
		name: '获取LOF套利机会',
		description: '获取基于市价与净值差异的LOF套利机会'
	},
	getFundTurnoverRate: {
		name: '获取基金换手率',
		description: '获取基金组合换手率，反映交易频率'
	},
	getFundManagerHistory: {
		name: '获取基金经理变更历史',
		description: '获取基金经理变更历史，包括任职日期和任期回报'
	},
	getSectorFundRanking: {
		name: '获取行业主题基金排名',
		description: '获取行业/主题基金业绩排名'
	},
	getFundBenchmarkComparison: {
		name: '获取基金业绩比较基准',
		description: '比较基金业绩与业绩比较基准'
	},
	getQdiiCurrencyExposure: {
		name: '获取QDII货币敞口',
		description: '获取QDII基金货币敞口，显示美元、欧元、港币、日元配置比例'
	},
	getFundHoldingsChange: {
		name: '获取基金持仓变动',
		description: '获取基金季度持仓变动情况'
	},
	getMoneyFundYieldRanking: {
		name: '获取货币基金收益排名',
		description: '获取货币市场基金7日年化收益率排名'
	},
	getFundShareholderConcentration: {
		name: '获取基金持有人结构',
		description: '获取基金持有人集中度，显示机构与散户占比'
	},
	getSmartBetaEtfMetrics: {
		name: '获取SmartBeta ETF指标',
		description: '获取SmartBeta ETF指标，包括因子暴露和跟踪效率'
	},
};
