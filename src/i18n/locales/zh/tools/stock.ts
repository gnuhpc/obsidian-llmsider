...
export const zhStockTools = {
	...
	getGeographicRevenue: {
		name: '获取地区收入分布',
		description: '获取按地区/国家划分的收入分布。显示市场渗透率和对不同经济体的敞口。多元化降低国家特定风险。'
	},
	getCustomerConcentration: {
		name: '获取客户集中度',
		description: '获取客户集中度，显示前5大客户占收入百分比。高集中度=如果失去主要客户则风险大。客户基础分散更安全。'
	},
	getSupplierConcentration: {
		name: '获取供应商集中度',
		description: '获取供应商集中度，显示前5大供应商占采购百分比。高集中度=议价能力弱且供应链风险大。多元化提高韧性。'
	},
	getInventoryAnalysis: {
		name: '获取存货分析',
		description: '获取存货分析，显示库存水平、周转天数、账龄。存货上升可能表明需求放缓或过时风险。快速周转=高效运营。'
	},
	getReceivablesAnalysis: {
		name: '获取应收账款分析',
		description: '获取应收账款分析，显示账龄、周转天数、坏账准备。应收账款上升可能表明回款问题或激进的收入确认。'
	},
	getGoodwillAnalysis: {
		name: '获取商誉分析',
		description: '获取商誉分析和减值风险，来自并购。商誉占资产比例高有风险 - 减值费用可能抹去盈利。监控并购后表现。'
	},
	getContingentLiabilities: {
		name: '获取或有负债',
		description: '获取或有负债，包括担保、未决诉讼、税务争议。可能实现的表外风险。仔细检查附注。'
	},
	getRelatedPartyTransactions: {
		name: '获取关联交易',
		description: '获取与控股股东、子公司的关联交易。过度的关联交易可能表明利润操纵或掏空。'
	},
	getOffBalanceSheetItems: {
		name: '获取表外项目',
		description: '获取表外项目，包括经营租赁、特殊目的实体。可能隐藏重大负债。对真实财务状况评估很重要。'
	},
	getAccountingPolicy: {
		name: '获取会计政策',
		description: '获取会计政策和变更，包括折旧方法、收入确认、存货计价。频繁变更可能是盈余管理的红色信号。'
	},
	getAuditorOpinion: {
		name: '获取审计意见',
		description: '获取审计意见 - 无保留、保留、否定、无法表示意见。非无保留意见是重大红色信号。还要检查审计师变更。'
	},
	getFinancialFootnotes: {
		name: '获取财报附注',
		description: '获取财务报表附注要点，包括重大会计判断、风险、承诺。附注中往往隐藏的细节对尽职调查至关重要。'
	},
	getMda: {
		name: '获取管理层讨论与分析',
		description: '获取管理层讨论与分析(MD&A)，提供管理层对业绩、前景、风险的看法。对比管理层语调与实际表现。'
	},
	getFinancialRedFlags: {
		name: '获取财务预警信号',
		description: '获取财务预警信号筛查，检查预警信号：利润率下降、应收账款上升、存货堆积、负现金流、过度负债、频繁会计变更。'
	},
	getAltmanZScore: {
		name: '获取Altman Z值',
		description: '获取Altman Z值(破产预测模型)，综合营运资本、留存收益、息税前利润、权益、销售预测破产风险。Z < 1.8 = 高风险，Z > 3.0 = 安全区。'
	},
	getPiotroskiFScore: {
		name: '获取Piotroski F值',
		description: '获取Piotroski F值，根据9项标准评估财务健康度：盈利能力、杠杆、流动性、运营效率。F值8-9 = 强劲，0-1 = 疲弱。价值投资工具。'
	},
	getBeneishMScore: {
		name: '获取Beneish M值',
		description: '获取Beneish M值(盈余操纵检测)，通过8个财务比率检测盈余操纵。M值 > -2.22表明高操纵概率。财务欺诈检测工具。'
	},
