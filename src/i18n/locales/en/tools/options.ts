...
export const enOptionsTools = {
	getCurrentTime: {
		...
		optionSseSpotPriceSina: {
			name: 'Get SSE Option Spot Price',
			description: 'Get real-time spot prices for Shanghai Stock Exchange (SSE) options, including bid/ask prices, volume, and open interest.'
		},
		optionSseUnderlyingSpotPriceSina: {
			name: 'Get SSE Option Underlying Spot Price',
			description: 'Get real-time spot prices for the underlying assets of SSE options (e.g., 50ETF, 300ETF, stocks).'
		},
		optionSseGreeksSina: {
			name: 'Get SSE Option Greeks',
			description: 'Get option Greeks (Delta, Gamma, Theta, Vega, Rho) for SSE options from Sina Finance. Essential for option risk management.'
		},
		optionSseMinuteSina: {
			name: 'Get SSE Option Minute Data',
			description: 'Get minute-level tick data for SSE options including price, volume, and open interest changes for intraday analysis.'
		},
		optionSseDailySina: {
			name: 'Get SSE Option Daily Data',
			description: 'Get daily historical data for SSE options including OHLC, volume, open interest, and settlement prices.'
		},
		optionFinanceMinuteSina: {
			name: 'Get Finance Option Minute Data',
			description: 'Get minute-level data for financial options (index options like CFFEX 50, 300, 1000) from Sina Finance.'
		},
		optionMinuteEm: {
			name: 'Get Option Minute Data (East Money)',
			description: 'Get minute-level option data from East Money platform, covering SSE and SZSE options with detailed intraday quotes.'
		},
	optionCffexHs300DailySina: {
		name: 'Get CFFEX CSI 300 Option Daily Data',
		description: 'Get daily historical data for CFFEX CSI 300 index options including OHLC, volume, open interest, and Greeks.'
	},
	optionCffexSz50ListSina: {
		name: 'Get CFFEX SSE 50 Option List',
		description: 'Get list of available CFFEX SSE 50 ETF option contracts with contract codes, strike prices, and expiration dates.'
	},
	optionCffexHs300ListSina: {
		name: 'Get CFFEX CSI 300 Option List',
		description: 'Get list of available CFFEX CSI 300 index option contracts with contract codes, strike prices, and expiration dates.'
	},
	optionCffexZz1000ListSina: {
		name: 'Get CFFEX CSI 1000 Option List',
		description: 'Get list of available CFFEX CSI 1000 index option contracts with contract codes, strike prices, and expiration dates.'
	},
};