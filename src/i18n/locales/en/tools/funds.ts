...
export const enFundsTools = {
	...
	getFundManagerPerformance: {
		name: 'Get Fund Manager Performance',
		description: 'Get fund manager performance ranking and statistics'
	},
	getFundFlow: {
		name: 'Get Fund Flow',
		description: 'Get fund subscription and redemption flow data'
	},
	getEtfTracking: {
		name: 'Get ETF Tracking',
		description: 'Get ETF real-time tracking data including tracking error and premium/discount rate'
	},
	getFundAllocationIndex: {
		name: 'Get Fund Allocation Index',
		description: 'Get fund asset allocation index including stock position, bond position, and sector allocation'
	},
	getFundComparison: {
		name: 'Get Fund Comparison',
		description: 'Compare performance metrics of multiple funds including returns, volatility, Sharpe ratio, max drawdown'
	},
	getFundFees: {
		name: 'Get Fund Fees',
		description: 'Get fund fee structure including subscription fee, redemption fee, management fee, custodian fee'
	},
	getFundRiskMetrics: {
		name: 'Get Fund Risk Metrics',
		description: 'Get fund risk metrics including volatility, beta, Sharpe ratio, maximum drawdown, VaR'
	},
	getFundStyleAnalysis: {
		name: 'Get Fund Style Analysis',
		description: 'Get fund investment style analysis including growth/value orientation and sector preferences'
	},
	getFundCompanyRanking: {
		name: 'Get Fund Company Ranking',
		description: 'Get fund company ranking by total assets, fund count, average performance'
	},
	getEtfArbitrage: {
		name: 'Get ETF Arbitrage',
		description: 'Get ETF arbitrage opportunities based on premium/discount rate'
	},
	getLofArbitrage: {
		name: 'Get LOF Arbitrage',
		description: 'Get LOF arbitrage opportunities based on premium/discount rate between market price and NAV'
	},
	getFundTurnoverRate: {
		name: 'Get Fund Turnover Rate',
		description: 'Get fund portfolio turnover rate indicating trading frequency'
	},
	getFundManagerHistory: {
		name: 'Get Fund Manager History',
		description: 'Get fund manager change history including appointment dates and tenure returns'
	},
	getSectorFundRanking: {
		name: 'Get Sector Fund Ranking',
		description: 'Get sector/theme fund ranking by performance'
	},
	getFundBenchmarkComparison: {
		name: 'Get Fund Benchmark Comparison',
		description: 'Compare fund performance against its benchmark index'
	},
	getQdiiCurrencyExposure: {
		name: 'Get QDII Currency Exposure',
		description: 'Get QDII fund currency exposure showing USD, EUR, HKD, JPY allocation'
	},
	getFundHoldingsChange: {
		name: 'Get Fund Holdings Change',
		description: 'Get quarter-over-quarter fund holdings changes'
	},
	getMoneyFundYieldRanking: {
		name: 'Get Money Fund Yield Ranking',
		description: 'Get money market fund 7-day annualized yield ranking'
	},
	getFundShareholderConcentration: {
		name: 'Get Fund Shareholder Concentration',
		description: 'Get fund shareholder concentration showing institutional vs retail proportions'
	},
	getSmartBetaEtfMetrics: {
		name: 'Get Smart Beta ETF Metrics',
		description: 'Get smart beta ETF metrics including factor exposure and tracking efficiency'
	},
};
