...
export const enStockTools = {
	...
	getGeographicRevenue: {
		name: 'Get Geographic Revenue',
		description: 'Get geographic revenue distribution by region/country. Shows market penetration and exposure to different economies. Diversification reduces country-specific risk.'
	},
	getCustomerConcentration: {
		name: 'Get Customer Concentration',
		description: 'Get customer concentration (客户集中度) showing top 5 customer % of revenue. High concentration = risk if major customer is lost. Diversified customer base is safer.'
	},
	getSupplierConcentration: {
		name: 'Get Supplier Concentration',
		description: 'Get supplier concentration (供应商集中度) showing top 5 supplier % of purchases. High concentration = weak bargaining power and supply chain risk. Diversification improves resilience.'
	},
	getInventoryAnalysis: {
		name: 'Get Inventory Analysis',
		description: 'Get inventory analysis showing inventory levels, turnover days, aging. Rising inventory may indicate slowing demand or obsolescence risk. Fast turnover = efficient operations.'
	},
	getReceivablesAnalysis: {
		name: 'Get Receivables Analysis',
		description: 'Get accounts receivable analysis showing aging, turnover days, bad debt provision. Rising receivables may indicate collection problems or aggressive revenue recognition.'
	},
	getGoodwillAnalysis: {
		name: 'Get Goodwill Analysis',
		description: 'Get goodwill analysis and impairment risk (商誉减值风险) from M&A. High goodwill as % of assets is risky - impairment charges can wipe out earnings. Monitor post-acquisition performance.'
	},
	getContingentLiabilities: {
		name: 'Get Contingent Liabilities',
		description: 'Get contingent liabilities (或有负债) including guarantees, pending lawsuits, tax disputes. Off-balance sheet risks that could materialize. Check footnotes carefully.'
	},
	getRelatedPartyTransactions: {
		name: 'Get Related Party Transactions',
		description: 'Get related party transactions (关联交易) with controlling shareholders, subsidiaries. Excessive related party transactions may indicate profit manipulation or tunneling.'
	},
	getOffBalanceSheetItems: {
		name: 'Get Off-Balance Sheet Items',
		description: 'Get off-balance sheet items (表外项目) including operating leases, special purpose entities. Can hide significant liabilities. Important for true financial position assessment.'
	},
	getAccountingPolicy: {
		name: 'Get Accounting Policy',
		description: 'Get accounting policy and changes (会计政策变更) including depreciation methods, revenue recognition, inventory valuation. Frequent changes may be red flag for earnings management.'
	},
	getAuditorOpinion: {
		name: 'Get Auditor Opinion',
		description: 'Get auditor opinion (审计意见) - unqualified, qualified, adverse, disclaimer. Non-unqualified opinions are major red flags. Also check for auditor changes.'
	},
	getFinancialFootnotes: {
		name: 'Get Financial Footnotes',
		description: 'Get financial statement footnotes highlights (财报附注) including significant accounting judgments, risks, commitments. Details often buried in footnotes are critical for due diligence.'
	},
	getMda: {
		name: 'Get MD&A',
		description: 'Get management discussion and analysis (MD&A/管理层讨论与分析) providing management perspective on results, outlook, risks. Compare management tone with actual performance.'
	},
	getFinancialRedFlags: {
		name: 'Get Financial Red Flags',
		description: 'Get financial red flags screening (财务预警) checking for warning signals: falling margins, rising receivables, inventory buildup, negative cash flow, excessive debt, frequent accounting changes.'
	},
	getAltmanZScore: {
		name: 'Get Altman Z-Score',
		description: 'Get Altman Z-Score (Z值/破产预测模型) combining working capital, retained earnings, EBIT, equity, sales to predict bankruptcy risk. Z < 1.8 = high risk, Z > 3.0 = safe zone.'
	},
	getPiotroskiFScore: {
		name: 'Get Piotroski F-Score',
		description: 'Get Piotroski F-Score (F值) scoring financial strength on 9 criteria: profitability, leverage, liquidity, operating efficiency. F-Score 8-9 = strong, 0-1 = weak. Value investing tool.'
	},
	getBeneishMScore: {
		name: 'Get Beneish M-Score',
		description: 'Get Beneish M-Score (M值/盈余操纵检测) detecting earnings manipulation through 8 financial ratios. M-Score > -2.22 suggests high manipulation probability. Fraud detection tool.'
	},
	stockFinancialRatios: {
		name: 'Get Stock Financial Ratios',
		description: 'Get stock key financial indicators and ratio analysis'
	},
};