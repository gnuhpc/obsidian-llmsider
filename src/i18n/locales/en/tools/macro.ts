...
getUSNonFarmPayroll: {
		...
		macroChinaCpi: {
			name: 'Get China CPI Data',
			description: 'Get China Consumer Price Index (CPI) data reflecting inflation levels and consumer price changes over time.'
		},
		macroChinaPpi: {
			name: 'Get China PPI Data',
			description: 'Get China Producer Price Index (PPI) data reflecting industrial product price changes and wholesale inflation trends.'
		},
		macroChinaPmi: {
			name: 'Get China PMI Data',
			description: 'Get China Purchasing Managers\' Index (PMI) data for manufacturing and services sectors, indicating economic expansion or contraction.'
		},
		macroChinaGdp: {
			name: 'Get China GDP Data',
			description: 'Get China Gross Domestic Product (GDP) data showing economic growth rates and economic size, quarterly and annual data available.'
		},
		macroChinaSocialFinancing: {
			name: 'Get China Social Financing Data',
			description: 'Get China total social financing data reflecting aggregate financing to the real economy, including bank loans, bonds, and equity.'
		},
		macroChinaMoneySupply: {
			name: 'Get China Money Supply Data',
			description: 'Get China money supply data (M0, M1, M2) reflecting currency circulation and broad money liquidity in the economy.'
		},
		macroChinaForexReserve: {
			name: 'Get China Forex Reserve Data',
			description: 'Get China foreign exchange reserve data showing national reserve assets and international payment capacity.'
		},
		macroChinaTradeBalance: {
			name: 'Get China Trade Balance Data',
			description: 'Get China import/export trade data and trade balance (surplus/deficit), reflecting external economic activity.'
		},
};
