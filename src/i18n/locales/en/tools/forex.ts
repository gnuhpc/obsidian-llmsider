...
export const enForexTools = {
	getFXSpotQuote: {
		...
		fxSwapQuote: {
			name: 'Get FX Swap Quote',
			description: 'Get foreign exchange swap quote data, including forward points and swap prices for different tenors.'
		},
		fxPairQuote: {
			name: 'Get FX Pair Quote',
			description: 'Get detailed quotes for currency pairs, including bid/ask spreads, pip values, and trading information.'
		},
		fxMajorPairsRealtime: {
			name: 'Get Major FX Pairs Realtime',
			description: 'Get real-time quotes for major foreign exchange currency pairs (USD/CNY, EUR/USD, GBP/USD, etc.) with comprehensive market data.'
		},
};
