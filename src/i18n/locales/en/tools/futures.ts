...
export const enFuturesTools = {
	...
	// Futures roll yield and position ranking tools
	getRollYieldBar: {
		name: 'Get Futures Roll Yield',
		description: 'Get futures roll yield data (期货展期收益率). Roll yield reflects the spread relationship between the main contract and the second main contract, used to judge the term structure of the futures market.'
	},
	getCffexRankTable: {
		name: 'Get CFFEX Position Ranking',
		description: 'Get China Financial Futures Exchange (CFFEX) top 20 members position data detail showing institutional positions in index futures and treasury futures.'
	},
	getRankTableCzce: {
		name: 'Get CZCE Position Ranking',
		description: 'Get Zhengzhou Commodity Exchange (CZCE) position ranking by member showing top holders for agricultural and industrial commodity futures.'
	},
	getDceRankTable: {
		name: 'Get DCE Position Ranking',
		description: 'Get Dalian Commodity Exchange (DCE) position ranking showing top members positions in agricultural and chemical futures contracts.'
	},
	// Cryptocurrency market tools
	cryptoMarketCapRanking: {
		name: 'Get Crypto Market Cap Ranking',
		description: 'Get cryptocurrency market capitalization rankings. Shows major cryptocurrencies ranked by market cap with price, volume, and market dominance data.'
	},
	cryptoBitcoinPriceTrend: {
		name: 'Get Bitcoin Price Trend',
		description: 'Get Bitcoin historical price trends. Provides OHLCV data for Bitcoin with technical analysis indicators.'
	},
	cryptoExchangeRanking: {
		name: 'Get Crypto Exchange Ranking',
		description: 'Get cryptocurrency exchange rankings. Shows major exchanges ranked by trading volume, liquidity, and number of supported coins.'
	},
	cryptoDefiTvl: {
		name: 'Get DeFi Total Value Locked',
		description: 'Get DeFi protocol Total Value Locked (TVL) data. Shows the amount of crypto assets locked in decentralized finance protocols.'
	},
	cryptoNftMarketData: {
		name: 'Get NFT Market Data',
		description: 'Get NFT (Non-Fungible Token) market data. Includes trading volume, floor prices, active users, and trending collections.'
	},
	getShfeVWap: {
		name: 'Get SHFE VWAP',
		description: 'Get Shanghai Futures Exchange daily volume weighted average price data'
	},
	getGfexDaily: {
		name: 'Get GFEX Daily',
	...
	getReceiptDate: {
		name: 'Get Receipt Date',
		description: 'Get futures warehouse receipt validity period data for understanding receipt expiration times'
	},
	futuresSettlementPriceSgx: {
		name: 'Get SGX Futures Settlement Price',
		description: 'Get Singapore Exchange futures varieties daily trading data'
	},
	futuresZhSpot: {
		name: 'Get Domestic Futures Spot',
		description: 'Get domestic futures real-time quotes data including all exchange futures varieties'
	},
	futuresExchangeList: {
	...
	futuresTradingTime: {
		...
		description: 'Get futures trading hours including day and night sessions'
	},
	futuresContractMultiplier: {
		name: 'Get Futures Contract Multiplier',
		description: 'Get futures contract multiplier (tons per lot) and trading unit'
	},
	futuresMarginRatio: {
	...
	futuresZhRealtime: {
		name: 'Get Domestic Futures Realtime',
		description: 'Get domestic futures real-time quotes for specified varieties (steel, copper, aluminum, etc.)'
	},
	futuresForeignCommodityRealtime: {
		name: 'Get Foreign Futures Realtime',
		description: 'Get foreign futures real-time quotes including LME, COMEX, NYMEX exchange varieties'
	},
	futuresForeignHist: {
		name: 'Get Foreign Futures Historical',
		description: 'Get foreign futures historical quotes data'
	},
	futuresForeignDetail: {
		name: 'Get Foreign Futures Contract Detail',
		description: 'Get foreign futures contract detailed information including exchange, contract unit, tick size'
	},
	futuresZhMinuteSina: {
		name: 'Get Domestic Futures Minute Data',
		description: 'Get domestic futures minute-level quotes data (1-minute level)'
	},
};