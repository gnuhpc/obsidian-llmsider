...
export const enAutocomplete = {
  ...
  customPromptDesc: 'Write your own completion constraints to append to the autocomplete prompt',
  customPromptPlaceholder: 'e.g., Keep my writing style; avoid filler; prefer concise, information-dense continuations',
