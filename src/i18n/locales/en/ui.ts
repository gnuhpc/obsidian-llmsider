...
export const enUI = {
  ...
  skillsSwitchOn: 'Skills On',
  skillsSwitchOff: 'Skills Off',
  skillsEnabled: 'Skills enabled for current chat',
  skillsDisabled: 'Skills disabled for current chat',
  noSkill: 'No Skill',
  noSkillDesc: 'Use the base assistant behavior for this chat.',
  noActiveChatSession: 'No active chat session',
...
{globalSuffix}`,
  ...
  chatHistoryEmpty: 'No conversations found',
  chatHistoryUntitledConversation: 'Untitled Conversation',
  chatHistoryMessageCount: '{count} messages',
  chatHistoryDeleteConversation: 'Delete conversation',
  chatHistoryDeleteAll: 'Delete All',
  chatHistoryDeleteAllAriaLabel: 'Delete all conversations',
  chatHistoryDeleteAllDone: 'All conversations deleted',
  chatHistoryImagePlaceholder: '[Image]',
  chatHistoryMaxLimitTitle: 'Maximum Chat History Reached',
  chatHistoryMaxLimitMessage: 'You have reached the maximum chat history limit of {count} conversations.',
  chatHistoryMaxLimitWarning: 'To create a new chat, the oldest conversation will be automatically removed.',
  chatHistoryMaxLimitProceed: 'Continue & Remove Oldest',
  ...
  currentChatSkills: 'Current Chat',
  ...
  allSkillsDisabled: 'All skills disabled',
  ...
  cannotChangeSkillDuringExecution: 'Cannot change skill during execution',
  cannotAddContextDuringExecution: 'Cannot add context during execution',
  skillManagerNotInitialized: 'Skill manager is not initialized',
  skillMatched: 'Skill matched: {skill}',
  skillsReloaded: 'Reloaded {count} local skill(s)',
  skillsReloadedWithErrors: 'Reloaded skills with {count} error(s)',
  ...
  activeSkillCleared: 'Active skill cleared for current chat',
  ...
  continueQuestion: 'Continue with guided assist?',
  continueWithSuggestions: 'Continue with suggestions',
  endGuidedMode: 'Turn off guided assist',
  guidedModeEnded: 'Guided assist turned off. You can keep chatting normally or turn it on again anytime.',
...
- For write/create/save requests, the final answer must include an explicit write-success signal (for example: created/saved).`,
  ...
  freeQwenToolCallWarning: '⚠️ Free Qwen does not support automatic tool calling. In Guided Assist / Agent mode, AI may only describe tools in text instead of executing them. Consider using paid Qwen (DashScope) or switch to Normal mode.',
  ...
  webllm: {
    sectionTitle: '🧠 Local Inference Engine',
    sectionDesc: 'Run AI models locally using WebGPU — no internet or external services needed',
    enableWebLLM: 'Enable Local Inference',
    enableWebLLMDesc: 'Use WebGPU to run AI inference locally without API keys',
    webgpuSupported: '✅ Your device supports WebGPU',
    webgpuNotSupported: '❌ WebGPU is not supported. Please update your GPU drivers.',
    ...
    clearCacheConfirm: 'Clear all downloaded model files? You will need to re-download them next time.',
    cacheCleared: 'Model cache cleared',
    modelReady: '✅ Model is ready for conversation',
    modelSize: 'Size',
    contextWindow: 'Context Window',
    autoLoad: 'Auto-load on Startup',
    autoLoadDesc: 'Automatically load the selected local model when Obsidian starts',
    statusIdle: 'Idle',
    ...
    connectionTitle: 'WebLLM (Local Inference)',
    connectionDesc: 'Run language models directly in Obsidian using your device\'s GPU (WebGPU). No API key or internet connection required for inference (only for initial model download).',
