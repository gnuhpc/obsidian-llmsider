...
export const enSettings = {
	settingsPage: {
		...
		skills: {
			title: 'Skills',
			description: 'Manage local skills loaded from your vault.',
			notInitialized: 'Skill manager is not initialized.',
			globalToggle: 'Enable Skills Globally',
			globalToggleDesc: 'Globally enable or disable local skills. When disabled, no chat will use Skills.',
			directory: 'Skills Directory',
			directoryDesc: 'Vault-relative directory used to scan local skill manifests.',
			saveAndReload: 'Save & Reload',
			directoryUpdated: 'Skills directory updated',
			reload: 'Reload Skills',
			loadErrors: 'Load Errors',
			noSkillsFound: 'No local skills found in the configured directory.',
			setAsDefault: 'Set as default',
			activateForCurrentChat: 'Activate for current chat',
			defaultBadge: 'default',
			market: {
				title: 'Skills Market',
				description: 'Search remote skills and install them into your local skills directory.',
				apiToken: 'API Token',
				apiTokenPlaceholder: 'Paste Skills Market API token',
				onboarding: 'Before searching Skills, create a Skills Market API token and paste it below.',
				createTokenAction: 'Create API token',
				tokenSaved: 'Skills Market API token saved locally',
				tokenSavedHint: 'Saved locally. You do not need to enter it again.',
				searchPlaceholder: 'Search skills...',
				searchAction: 'Search',
				searching: 'Searching...',
				empty: 'Search the market to view installable skills.',
				noResults: 'No matching skills found.',
				prevPage: 'Previous',
				nextPage: 'Next',
				installed: 'Installed',
				reinstallBlocked: 'Installed',
				installAction: 'Install',
				installing: 'Installing...',
				installSuccess: 'Installed skill: {name}',
				viewOnGithub: 'GitHub',
				updatedAt: 'Updated',
				resultsSummary: 'Page {page} / {totalPages} · {total} results',
		...
		updateNotificationsDesc: 'Notify when a new version is available (BRAT upgrade)',
		checkForUpdates: 'Check for Updates',
		checkingForUpdates: 'Checking for updates...',
		updateAvailable: 'Update available: v{version}',
		noUpdateAvailable: 'You are using the latest version (v{version})',
		updateCheckFailed: 'Failed to check for updates',
		globalPromptSuffix: 'Global Prompt Suffix',
		globalPromptSuffixDesc: 'Optional. If set, this prompt is appended to the end of the system prompt for every model interaction.',
		...
		promptManagement: {
			...
			globalPrompts: 'Global Prompt',
			globalPromptsDesc: 'Appended to every system prompt across all chats.',
			globalPreConstraintPrompt: 'Pre-Task Constraint Prompt',
			globalPreConstraintPromptDesc: 'Optional. If set, this prompt is applied as a mandatory constraint while completing the user task.',
			globalAppendTaskPrompt: 'Append Task Prompt',
			globalAppendTaskPromptDesc: 'Optional. If set, this prompt is executed after the user task and appended to the end of the response.',
			searchPlaceholder: 'Search prompts...',
			addPrompt: 'Add Prompt',
			addChatPrompt: 'Add Chat Prompt',
			addSpeedReadingPrompt: 'Add Speed Reading Prompt',
			builtInPrompts: 'Built-in Prompts',
			customPrompts: 'Custom Prompts',
			speedReadingPrompts: 'Speed Reading Prompts',
			builtInBadge: 'BUILT-IN',
			customBadge: 'CUSTOM',
			totalPrompts: 'Total Prompts',
			chatPromptType: 'Chat',
			speedReadingPromptType: 'Speed Reading',
			placeholderReady: '{} placeholder ready',
			placeholderMissing: '{} placeholder missing',
			characters: 'characters',
			lines: 'lines',
			livePreview: 'Live Preview',
			previewEmpty: 'Start writing the prompt content to see a live preview here.',
	...
	notifications: {
		...
		plugin: {
			...
			updateAvailable: 'Update available: v{version}. Open BRAT and click Upgrade.'
		},
		// Chat related
		chat: {
