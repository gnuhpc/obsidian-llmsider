// Google search tools for web search functionality - Mastra format
import { z } from 'zod';
 ...
 */
export const googleSearchTool: MastraTool = createMastraTool({
  category: 'search-web',
  id: 'google_search',
  description: 'Search the web using Google. Supports Google Custom Search API, SerpAPI, Tavily, or DuckDuckGo. Returns URLs of relevant search results.',
  
  inputSchema: z.object({
    query: z.string()
      .min(1)
      .describe('REQUIRED: The search query string (e.g., "tesla news", "latest AI developments")'),
    ...
    num_results: z.number()
      ...
      .optional()
      .default(10)
      .describe('Number of search results to return (default: 10, max: 10)')
  }),
  
  outputSchema: z.array(z.string().describe('Result URL'))
    .describe('Array of URLs from web search results'),
