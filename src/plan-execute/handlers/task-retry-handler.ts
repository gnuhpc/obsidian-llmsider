...
export class TaskRetryHandler {
	constructor(
		...
		private getStepFailureInfo: () => Map<string, any>,
		...
		private getExecutionResults: () => any[],
		private getPendingToolFailure: () => any,
		private setPendingToolFailure: (value: any) => void,
		...
		private intelligentlyRegenerateStepFn: (originalStep: any, stepIndex: number, error: Error) => Promise<any>
	) {}
